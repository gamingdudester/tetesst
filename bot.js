...
client.on("message", async message => {
  ...
  { 
    //log messages
    client.channels.find("Frostbot Database", message.channel.id.toString()).send("Welcome!").send(message.guild.name + ","+ message.channel.name + ","  + message.author.username + ": " + message.content);
